...
__all__ = [
    "transformer_base_patch16_224_8k_vocab",
    "transformer_large_patch16_224_8k_vocab",
...
@register_model
def transformer_base_patch16_224_8k_vocab(pretrained=False, **kwargs):
...
@register_model
def transformer_base_patch8_224_8k_vocab(pretrained=False, **kwargs):
    model = VisionTransformerForMaskedImageModeling(
        patch_size=8,
        embed_dim=768,
        depth=12,
...
@register_model
def transformer_large_patch16_224_8k_vocab(pretrained=False, **kwargs):
    model = VisionTransformerForMaskedImageModeling(
        patch_size=16,
        embed_dim=1024,
        depth=24,
