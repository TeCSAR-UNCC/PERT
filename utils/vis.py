...
def view_skeleton_batch(batch, PATH="", NAME=""):
    ...
    for skeleton_data1, skeleton_data2 in tqdm(zip(batch[0], batch[1])):
        ...
        # Convert the plot to an image and save to video
        fig.tight_layout()  # To ensure annotations and joints don't get cut off
        fig.canvas.draw()
