model = dict(
    ...
    cls_head=dict(type="I3DHead", in_channels=512, num_classes=60, dropout=0.5),
...
data = dict(
    ...
    val=dict(
        type=dataset_type, ann_file=ann_file, split="xview_val", pipeline=val_pipeline
    ),
    test=dict(
        type=dataset_type, ann_file=ann_file, split="xview_val", pipeline=test_pipeline
    ),
)
# optimizer
optimizer = dict(
