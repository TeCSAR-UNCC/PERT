...
config_file="/home/galinezh/PERT/configs/PERT/PEiT_UBnormal_Forzen_finetune_base_3d.yaml"
...
for abnormal_w in "${abnormal_ws[@]}"; do
    for weight_decay in "${weight_decays[@]}"; do
        for aug_abnormal in "${aug_abnormals[@]}"; do
            ...
            sed -i "s/custom_run_name: .*/custom_run_name: \"UBnormal_frozen_search_$counter\"/" $config_file
